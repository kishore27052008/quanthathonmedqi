  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Reports & Clinical Analytics</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-slate-900 font-mono mt-3">{total}</h3>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-red-600 font-mono mt-3">{totalHigh}</h3>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-amber-600 font-mono mt-3">{totalMed}</h3>
        ...
        <div className="bg-white rounded-2xl p-5 border border-slate-100 shadow-sm">
          ...
          <h3 className="text-3xl font-black text-emerald-600 font-mono mt-3">{totalLow}</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
          <div className="mb-6">
            <h3 className="text-base font-bold text-slate-900">Risk Trend Over Time</h3>
